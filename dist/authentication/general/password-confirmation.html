				...
				<div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-20">
					...
					<div class="pt-lg-10">
						...
						<div class="text-center">
							<a href="../../demo1/dist/authentication/flows/basic/sign-in.html" class="btn btn-primary btn-lg fw-bolder">Sign In</a>
						</div>
						<!--end::Action-->
						<!--begin::Action-->
						<div class="text-gray-700 fw-bold fs-4 pt-7">Did’t receive an email?
						<a href="../../demo1/dist/authentication/flows/basic/password-reset.html" class="text-primary fw-bolder">Try Again</a></div>
						<!--end::Action-->
					</div>
					<!--end::Wrapper-->
				</div>
